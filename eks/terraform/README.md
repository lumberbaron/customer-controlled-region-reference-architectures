...
| <a name="input_bastion_subnet_id"></a> [bastion\_subnet\_id](#input\_bastion\_subnet\_id) | When 'create\_network' is set to false, the bastion subnet ID must be provided if a bastion is to be created. | `string` | `null` | no |
