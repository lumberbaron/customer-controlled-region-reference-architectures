...
| <a name="input_cluster_subnet_ids"></a> [cluster\_subnet\_ids](#input\_cluster\_subnet\_ids) | When 'create\_network' is set to false, the cluster subnet IDs must be provided if they are to be used. | `list(string)` | `null` | no |
